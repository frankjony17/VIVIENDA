...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => '127.0.0.1', 'port' => 5432, 'dbname' => 'vivienda_db', 'user' => 'devusr', 'password' => 'devusr', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\AdminBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\NomencladorBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\QuejasBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'AdminBundle\\Entity');
        $c->addDriver($b, 'NomencladorBundle\\Entity');
        $c->addDriver($b, 'QuejasBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('AdminBundle' => 'AdminBundle\\Entity', 'NomencladorBundle' => 'NomencladorBundle\\Entity', 'QuejasBundle' => 'QuejasBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_d263f1a7a6ffc5b764cf227522a075724e462983389e548112a524daa678b12d');
    ...
    {
        return $this->services['knp_snappy.image'] = new \Knp\Bundle\SnappyBundle\Snappy\LoggableGenerator(new \Knp\Snappy\Image('"C:\\Program Files\\wkhtmltopdf\\bin\\wkhtmltoimage.exe"', array(), array()), NULL);
    }
    ...
    {
        return $this->services['knp_snappy.pdf'] = new \Knp\Bundle\SnappyBundle\Snappy\LoggableGenerator(new \Knp\Snappy\Pdf('"C:\\Program Files\\wkhtmltopdf\\bin\\wkhtmltopdf.exe"', array(), array()), NULL);
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $g = new \Symfony\Component\HttpFoundation\RequestMatcher('^/nomenclador');

        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/quejas');

        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/despacho');

        $j = new \Symfony\Component\Security\Http\AccessMap();
        $j->add($f, array(0 => 'ROLE_ADMIN'), NULL);
        $j->add($g, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_ENTREVISTA', 2 => 'ROLE_JEFEDEPARTAMENTO', 3 => 'ROLE_DESPACHO'), NULL);
        $j->add($h, array(0 => 'ROLE_ENTREVISTA', 1 => 'ROLE_JEFEDEPARTAMENTO', 2 => 'ROLE_DESPACHO'), NULL);
        $j->add($i, array(0 => 'ROLE_DESPACHO'), NULL);
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($j, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), NULL), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.database')), 'secured_area', NULL, $b), 2 => $l, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $e, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $k, 'secured_area', $m, $n, array('check_path' => '_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), NULL, $b, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AccessListener($a, $this->get('security.access.decision_manager'), $j, $e)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $k, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($d, $k, '_login', false), NULL, NULL, NULL, false));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\QuejasBundle/Resources/views'), 'Quejas');
        $instance->addPath(($this->targetDirs[3].'\\src\\DespachoBundle/Resources/views'), 'Despacho');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addYamlMappings(array(0 => ($this->targetDirs[3].'\\src\\NomencladorBundle\\Resources\\config\\validation.yml'), 1 => ($this->targetDirs[3].'\\src\\QuejasBundle\\Resources\\config\\validation.yml')));
     ...
     */
    protected function getViv_UtilService()
    {
        return $this->services['viv.util'] = new \NomencladorBundle\Services\Util($this->get('doctrine.orm.default_entity_manager'), $this->get('validator'));
    }
    ...
    {
        return $this->services['security.user.provider.concrete.database'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'AdminBundle:Users', 'username', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'QuejasBundle' => 'QuejasBundle\\QuejasBundle',
                'DespachoBundle' => 'DespachoBundle\\DespachoBundle',
