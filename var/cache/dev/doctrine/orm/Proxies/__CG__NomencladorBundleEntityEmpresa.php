 ...
 */
class Empresa extends \NomencladorBundle\Entity\Empresa implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'NomencladorBundle\\Entity\\Empresa' . "\0" . 'id', '' . "\0" . 'NomencladorBundle\\Entity\\Empresa' . "\0" . 'nombre', '' . "\0" . 'NomencladorBundle\\Entity\\Empresa' . "\0" . 'codigo', '' . "\0" . 'NomencladorBundle\\Entity\\Empresa' . "\0" . 'telefonos', '' . "\0" . 'NomencladorBundle\\Entity\\Empresa' . "\0" . 'calle', '' . "\0" . 'NomencladorBundle\\Entity\\Empresa' . "\0" . 'entre', '' . "\0" . 'NomencladorBundle\\Entity\\Empresa' . "\0" . 'numero');
        }
