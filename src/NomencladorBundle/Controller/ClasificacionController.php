...
use NomencladorBundle\Entity\Clasificacion;

/**
 * @Route("nomenclador/clasificacion/")
 */
class ClasificacionController extends Controller
{
    /**
     * List All values from Clasificacion
     *
     * @Route("list")
     */
    public function listAction()
    {
        ...
        foreach($this->getDoctrine()->getManager()->getRepository('NomencladorBundle:Clasificacion')->findAll() as $value ) {
            $data[] = array(
                'id' => $value->getId(), 
    ...
    public function addEditAction(Request $rq)
    {
        ...
        /* Add or Edit Clasificacion */
        if ($rq->get('id')) {
            $entity = $em->getRepository('NomencladorBundle:Clasificacion')->find($rq->get('id'));
        } else {
    ...
    public function removeAction(Request $rq)
    {
        ...
        foreach (json_decode($rq->get('ids')) as $id) {
            $entity = $em->getRepository('NomencladorBundle:Clasificacion')->find($id);
            $em->remove($entity);
        }
        return new Response($em->flush());
    }
