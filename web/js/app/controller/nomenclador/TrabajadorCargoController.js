...
Ext.define('VIV.controller.nomenclador.TrabajadorCargoController', {
    extend: 'Ext.app.Controller',

    control: {
        /* Grid */
        'grid-trabajador_cargo': {
            afterrender: "afterRenderGrid",
            celldblclick: "dblclick",
            resize: "resize"
        },
        'grid-trabajador_cargo [text=Adicionar]': {
            click: "showWindows"
        },
        'grid-trabajador_cargo [text=Eliminar]': {
            click: "confirmRemove"
        },
        /* Form */
        'form-trabajador_cargo': {
            afterrender: "afterRenderForm"
        },
        'form-trabajador_cargo [text=Salvar]': {
            click: "isValid"
        },
        'form-trabajador_cargo [text=Editar]': {
            click: "isValid"
        }
    },
    /*  */
    ...
    showWindows: function () {
        Ext.create('VIV.view.nomenclador.trabajador_cargo.TrabajadorCargoForm', { autoShow: true, btnText: 'Salvar', title: 'Adicionar Trabajador Cargo' });
    },
    /*  */
    dblclick: function (view, td, cellIndex, record, tr, rowIndex) {

        var win = Ext.create('VIV.view.nomenclador.trabajador_cargo.TrabajadorCargoForm',{ btnText: 'Editar', title: 'Editar Trabajador Cargo' }),
    ...
    remove: function () {
        ...
        Ext.Ajax.request({
            url: '../nomenclador/trabajador_cargo/remove',
