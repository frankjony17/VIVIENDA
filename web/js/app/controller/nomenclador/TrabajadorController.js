...
Ext.define('VIV.controller.nomenclador.TrabajadorController', {
    ...
    control: {
        ...
        'grid-trabajador [text=Adicionar]': {
            click: "showWindows"
        },
        'grid-trabajador [text=Eliminar]': {
            click: "confirmRemove"
        },
        /* Form */
        'form-trabajador': {
        ...
        'form-trabajador [text=Salvar]': {
            click: "isValid"
        },
        'form-trabajador [text=Editar]': {
            click: "isValid"
        }
    },
    /*  */
    ...
    showWindows: function () {
        Ext.create('VIV.view.nomenclador.trabajador.TrabajadorForm', { autoShow: true, btnText: 'Salvar', title: 'Adicionar Trabajador' });
    },
    /*  */
    dblclick: function (view, td, cellIndex, record, tr, rowIndex) {

        var win = Ext.create('VIV.view.nomenclador.trabajador.TrabajadorForm',{ btnText: 'Editar', title: 'Editar Trabajador' }),
