...
Ext.define('VIV.controller.nomenclador.ConformidadController', {
    ...
    control: {
        ...
        'grid-conformidad [text=Adicionar]': {
            click: "showWindows"
        },
        'grid-conformidad [text=Eliminar]': {
            click: "confirmRemove"
        },
        /* Form */
        'form-conformidad': {
        ...
        'form-conformidad [text=Salvar]': {
            click: "isValid"
        },
        'form-conformidad [text=Editar]': {
            click: "isValid"
        }
    },
    /*  */
    ...
    showWindows: function () {
        Ext.create('VIV.view.nomenclador.conformidad.ConformidadForm', { autoShow: true, btnText: 'Salvar', title: 'Adicionar Conformidad' });
    },
    /*  */
    dblclick: function (view, td, cellIndex, record, tr, rowIndex) {

        var win = Ext.create('VIV.view.nomenclador.conformidad.ConformidadForm',{ btnText: 'Editar', title: 'Editar Conformidad' }),
    ...
    remove: function () {
        ...
        Ext.Ajax.request({
            url: '../nomenclador/conformidad/remove',
