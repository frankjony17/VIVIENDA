...
Ext.define('VIV.controller.nomenclador.EmpresaController', {
    ...
    control: {
        ...
        'grid-empresa [text=Adicionar]': {
            click: "showWindows"
        },
        'grid-empresa [text=Eliminar]': {
            click: "confirmRemove"
        },
        /* Form */
        'form-empresa': {
        ...
        'form-empresa [text=Salvar]': {
            click: "isValid"
        },
        'form-empresa [text=Editar]': {
            click: "isValid"
        }
    },
    /*  */
    ...
    showWindows: function () {
        Ext.create('VIV.view.nomenclador.empresa.EmpresaForm', { autoShow: true, btnText: 'Salvar', title: 'Adicionar Empresa' });
    },
    /*  */
    dblclick: function (view, td, cellIndex, record, tr, rowIndex) {

        var win = Ext.create('VIV.view.nomenclador.empresa.EmpresaForm',{ btnText: 'Editar', title: 'Editar Empresa' }),
    ...
    remove: function () {
        ...
        Ext.Ajax.request({
            url: '../nomenclador/empresa/remove',
