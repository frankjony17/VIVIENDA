...
Ext.define('VIV.controller.nomenclador.DepartamentoController', {
    ...
    control: {
        ...
        'grid-departamento [text=Adicionar]': {
            click: "showWindows"
        },
        'grid-departamento [text=Eliminar]': {
            click: "confirmRemove"
        },
        /* Form */
        'form-departamento': {
        ...
        'form-departamento [text=Salvar]': {
            click: "isValid"
        },
        'form-departamento [text=Editar]': {
            click: "isValid"
        }
    },
    /*  */
    ...
    showWindows: function () {
        Ext.create('VIV.view.nomenclador.departamento.DepartamentoForm', { autoShow: true, btnText: 'Salvar', title: 'Adicionar Departamento' });
    },
    /*  */
    dblclick: function (view, td, cellIndex, record, tr, rowIndex) {

        var win = Ext.create('VIV.view.nomenclador.departamento.DepartamentoForm',{ btnText: 'Editar', title: 'Editar Departamento' }),
