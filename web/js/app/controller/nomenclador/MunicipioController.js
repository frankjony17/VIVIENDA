...
Ext.define('VIV.controller.nomenclador.MunicipioController', {
    ...
    control: {
        ...
        'grid-municipio [text=Adicionar]': {
            click: "showWindows"
        },
        'grid-municipio [text=Eliminar]': {
            click: "confirmRemove"
        },
        /* Form */
        'form-municipio': {
        ...
        'form-municipio [text=Salvar]': {
            click: "isValid"
        },
        'form-municipio [text=Editar]': {
            click: "isValid"
        }
    },
    /*  */
    ...
    showWindows: function () {
        Ext.create('VIV.view.nomenclador.municipio.MunicipioForm', { autoShow: true, btnText: 'Salvar', title: 'Adicionar Municipio' });
    },
    /*  */
    dblclick: function (view, td, cellIndex, record, tr, rowIndex) {

        var win = Ext.create('VIV.view.nomenclador.municipio.MunicipioForm',{ btnText: 'Editar', title: 'Editar Municipio' }),
    ...
    remove: function () {
        ...
        Ext.Ajax.request({
            url: '../nomenclador/municipio/remove',
