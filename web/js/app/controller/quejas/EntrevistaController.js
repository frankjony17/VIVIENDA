...
Ext.define('VIV.controller.quejas.EntrevistaController', {
    ...
    control: {
        ...
        'form-entrevista [text=Salvar]': {
            click: "isValid"
        },
        'form-entrevista [text=Editar]': {
            click: "isValid"
        }
    },
    /*  */
    ...
    showWindows: function () {
        Ext.create('VIV.view.quejas.entrevista.EntrevistaForm', { autoShow: true, btnText: 'Salvar', title: 'Adicionar Entrevista' });
    },
    /*  */
    dblclick: function (view, td, cellIndex, record, tr, rowIndex) {

        var win = Ext.create('VIV.view.quejas.entrevista.EntrevistaForm',{ btnText: 'Editar', title: 'Editar Entrevista' }),
