...
Ext.define('VIV.view.nomenclador.trabajador_cargo.TrabajadorCargoGrid', {
    extend: 'Ext.grid.Panel',
    xtype: 'grid-trabajador_cargo',
    /* Config options */
    width: '100%',
    border: 1,
    ...
    tbar : [{
        text: 'Adicionar',
        tooltip: 'Adicionar trabajador_cargo',
        iconCls: 'fa fa-plus',
        action: 'add'
    },{
        text: 'Eliminar',
        tooltip: 'Eliminar trabajador_cargo',
        iconCls: 'fa fa-trash',
        action: 'remove'
    }, '->', {
        tooltip: 'Ayuda relacionada con trabajador_cargo',
        iconCls: 'fa fa-info',
        action: 'help'
    }]
});